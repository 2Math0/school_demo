  ...
  static ThemeData get lightTheme => ThemeData(
        ...
        switchTheme: SwitchThemeData(
          ...
          trackColor: WidgetStateProperty.resolveWith<Color>(
            (Set<WidgetState> states) {
              if (states.contains(WidgetState.disabled)) {
                return lightDividerColor.withAlpha(128);
              }
              if (states.contains(WidgetState.selected)) {
        ...
        chipTheme: ChipThemeData(
          backgroundColor: lightCardColor,
          disabledColor: lightDividerColor.withAlpha(50),
        ...
        progressIndicatorTheme: ProgressIndicatorThemeData(
          color: primaryColor,
          circularTrackColor: lightDividerColor.withAlpha(50),
          linearTrackColor: lightDividerColor.withAlpha(50),
        ),
      );
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        switchTheme: SwitchThemeData(
          ...
          trackColor: WidgetStateProperty.resolveWith<Color>(
            (Set<WidgetState> states) {
              if (states.contains(WidgetState.disabled)) {
                return darkDividerColor.withAlpha(128);
              }
              if (states.contains(WidgetState.selected)) {
                return primaryColor.withAlpha(128);
              }
        ...
        chipTheme: ChipThemeData(
          backgroundColor: darkCardColor,
          disabledColor: darkDividerColor.withAlpha(50),
          selectedColor: primaryColor,
          secondarySelectedColor: secondaryColor,
          padding: const EdgeInsets.symmetric(
            horizontal: defaultPadding,
        ...
        progressIndicatorTheme: ProgressIndicatorThemeData(
          color: primaryColor,
          circularTrackColor: darkDividerColor.withAlpha(50),
          linearTrackColor: darkDividerColor.withAlpha(50),
        ),
      );
}
